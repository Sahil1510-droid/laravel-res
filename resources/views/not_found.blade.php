...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('456876.jpg') }}" type="image/x-icon">
</head>
<style>
    * {
    ...
    @keyframes colorSlide {
        ...
        40% {
            background-color: rgb(186, 21, 219);
        }
...
<body>
    <div class="flex-container">
        <div class="text-center">
            ...
            <a href="user"><button type="button" name="button">Return To Home</button></a>
        </div>
    </div>
</body>
